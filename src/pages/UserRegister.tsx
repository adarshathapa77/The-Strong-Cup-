  ...
  return (
    <div className="min-h-screen bg-tea-cream flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
        <h1 className="text-3xl font-bold text-tea-brown mb-2">Create Account</h1>
        <p className="text-tea-brown/70 mb-6">Join THE STRONG CUP community</p>
        ...
        <p className="text-center mt-4 text-tea-brown/70">
          ...
          <Link to="/user/login" className="text-tea-gold font-semibold hover:underline">
            Login here
          </Link>
        </p>
      </div>
